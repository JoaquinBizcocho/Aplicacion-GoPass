...
fun RegisterScreen(navController: NavController) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Button(
                onClick = {
                    if (nombre.isNotEmpty() && telefono.isNotEmpty() && dni.isNotEmpty() && email.isNotEmpty() && password.length >= 6) {
                        ...
                        auth.createUserWithEmailAndPassword(email, password)
                            .addOnCompleteListener { task ->
                                if (task.isSuccessful) {
                                    ...
                                    val user = User(nombre = nombre, telefono = telefono, dni = dni, email = email )
                        ...
                        Toast.makeText(context, "Revisa los campos. La contraseña debe tener al menos 6 caracteres.", Toast.LENGTH_SHORT).show()
                    }
                },
                modifier = Modifier.fillMaxWidth()
            ) {
